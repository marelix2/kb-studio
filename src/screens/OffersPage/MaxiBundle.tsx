...
export const MaxiBundle = () => {
  return (
    <MainContainer id="maxi-bundle">
      <InnerWrapper>
        <BundlesWrapper>
          <PageHeader title={"maxi"} />
          <TextWrapper>
            <TextRow
              counter={"01"}
              text={"DLA KOGO JEST TEN PAKIET?"}
              description={`Pakiet przeznaczony jest dla osób, które potrzebują remontu wnętrza całego domu / mieszkania`}
            />
            <TextBulletPoints
              counter={"02"}
